...
import { getEventosEndpoints } from "../src/endpoints/eventos.js";
import { getTiposEventosEndpoints } from "../src/endpoints/tiposEventos.js";
...
export function addRestDirections(app) {
  ...
  app = getEventosEndpoints(app, upload);
  app = getTiposEventosEndpoints(app, upload);
